...
vim.opt.mouse = '' -- disabled by default
  ...
  -- Main LSP Configuration
  {
    ...
    config = function()
      ...
      local servers = {
        ...
        -- C
        clangd = {
          filetypes = { 'c', 'cpp', 'objc', 'objcpp', 'cuda' }, -- this excludes "proto".
        },
...
-- NOTE: open neo-tree when opening nvim specifying a file of type dir.
